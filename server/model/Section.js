...
sectionSchema.statics.addSection = async function(section,gradeLevel,adviser,department,status) {
    ...
    const newSection = await this.create({ section,gradeLevel,adviser,department,status });
    return newSection;
}
