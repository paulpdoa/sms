...
const { get_student_grades, add_student_grade, get_teacher_dashboard,get_teacher_student_attendance, add_students_attendance, get_students_in_section } = require('../controller/teacherController');
